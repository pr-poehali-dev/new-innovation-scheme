  ...
  const plans = [
    {
      ...
      price: "0 ₽",
      period: "навсегда",
      description: "Для небольших школ, которые хотят попробовать и оценить удобство.",
      features: [
        "До 100 учеников",
        "Онлайн-заказ еды",
        "Просмотр меню",
    ...
    },
    {
      ...
      price: "4 900 ₽",
      period: "в месяц",
      description: "Для школ, которые хотят полный контроль питания и довольных родителей.",
      features: [
        "Неограниченное число учеников",
        "Контроль питания для родителей",
    ...
    },
    {
      ...
      description: "Для сетей школ и муниципалитетов с централизованным управлением.",
      features: [
        "Несколько школ в одном кабинете",
    ...
    <section className="py-24 px-6 bg-secondary">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          >
            Начните бесплатно — без ввода карты. Подключите платный тариф, когда будете готовы.
          </motion.p>
        </div>
